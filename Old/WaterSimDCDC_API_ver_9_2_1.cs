           ...
           public partial class WaterSimManager : WaterSimManagerClass
           {
              ...
              /// </summary>
               ...
               private void initialize_ModelParameters()
               {
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_River_Flow, "SaltVerde River Flow", "SVRFLOW", geti_SaltVerde_River_Flow, 0, 5000000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Storage, "SaltVerde Storage", "SVRSTORE", geti_SaltVerde_Storage, 500000, 2500000));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epMeadLevel, "Mead Elevation (FT)", "MEADELEV", geti_ElevationMead, 800, 1300));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epTotal_Demand, "Total Demand", "TOTDEM", Total_Demand, 0, 500000));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epPopulation_Used, "Population", "POPUSED", Population_Used,PopGroup,null, 1000, 4000000));

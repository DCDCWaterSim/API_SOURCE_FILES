...
namespace WaterSimDCDC.Documentation
{
    ...
    public class WaterSimDescripItem
    {
        ...
        public WaterSimDescripItem(int aModelParam, string aDescrip, string aUnit, string aLongUnit, ModelParameterGroupClass[] theTopicGroups)
        {
            FModelParam = aModelParam;
            FDescription = aDescrip;
            FUnits = aUnit;
    ...
    public class Extended_Parameter_Documentation
    {
        ...
        internal void BuildDescripList()
        {
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epSurface_to_Vadose_Time_Lag, "The time in years it takes water recharged to the vadose zone to reach the aquifer to be used as  groundwater.", "yrs","Years",""));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epPCT_SurfaceWater_to_WaterBank, "The percent of extra [excess] surface water that is sent to a water bank if [WaterBank Source Option] is set to a Value=1.", "%", "Percentage", new ModelParameterGroupClass[1] { WaterSupplyGroup }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epUse_SurfaceWater_to_WaterBank, "The amount of water (source unknown) sent to a water bank if [WaterBank Source Option] is set to a Value=2.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[1] { WaterSupplyGroup }));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epSetPopulationsOn, "For each provider sets the population for areas off project (other) to this value. ", "Pers", "People",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epSetPopulationsOther, "For each provider sets the population for areas on project (SRP lands) to this value. ", "Pers", "People",""));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epGroundwater_Pumped_Municipal, "The total amount of annual groundwater pumped.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[1] { WaterSupplyGroup }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epGroundwater_Balance, "The total groundwater credits available at end of year.", "AF", "Acre Feet", new ModelParameterGroupClass[] { WaterSupplyGroup }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epSaltVerde_Annual_Deliveries_SRP, "The total annual surface water and pumped groundwater delivered by SRP.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[] { WaterSupplyGroup,SRVSurfaceWaterGroup }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epSaltVerde_Class_BC_Designations, "The total annual B & C designated ground water delivered by SRP.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[] { WaterSupplyGroup,SRVSurfaceWaterGroup }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epColorado_Annual_Deliveries, "The total annual surface water deliveries by CAP, does not included banked water.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[] { WaterSupplyGroup, SurfaceWaterGroup }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epGroundwater_Bank_Used, "The total annual amount of water delivered from water banking facilities.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[] { WaterSupplyGroup }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epGroundwater_Bank_Balance, "The total banked water supply available at end of year.", "AF", "Acre Feet", new ModelParameterGroupClass[] { WaterSupplyGroup }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epReclaimed_Water_Used, "The total annual amount of reclaimed water used.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[] { WaterSupplyGroup }));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epOnProjectPopulation, "Population for SRP member lands", "Pers","People",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epOtherPopulation, "All other population within the provider boundary", "Pers","People",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epPopulation_Used, "The population used (along with GPCD) to estimate demand for the completed simulation year.", "Pers","People",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epRegionalGWBalance, "MODFLOW estimates of groundwater on a water provider basis.", "AF", "Acre Feet", new ModelParameterGroupClass[1] { WaterSupplyGroup }));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epDeficit_Years, "Number of years to date (cumulative) in which there has been a deficit (not enough water supply to meet demand)", "yrs", "Years",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epPCT_GWAvailable, "Percent of original groundwater credits that are available each year.", "%", "Percentage", new ModelParameterGroupClass[1] { WaterSupplyGroup }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epYrsGWZero, "Number of years to date (cumulative) that groundwater credits have been zero or less.", "yrs","Years",""));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epYearsNotAssured, "Number of years to date (cumulative) that a 100 year Assured Water Supply could not be demonstrated.", "yrs", "Years", ""));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epYearsOfNonAWSTrigger, "Number of years with not being able to demonstrate 100 year Assured Water Supply before some policy action occurs.", "yrs", "Years", ""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epYearsOfNonAWSGPCDTrigger, "Number of years with not being able to demonstrate 100 year Assured Water Supply before GPCD is reduced.", "Yr","Year",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epTotalSupplyUsed, "The total of all supply sources used to meet demand.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[1] { WaterSupplyGroup }));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epTotalReclaimedUsed, "The total amount of reclaimed effluent produced.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[1] { WaterSupplyGroup }));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epProjectedOnProjectPop, "The annual population initially projected for SRP membership lands.", "Pers","People",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epProjectedOtherPop, "The annual population initially projected for non-SRP membership lands.", "Pers","People",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epProjectedTotalPop, "The total annual population initially projected.", "Pers","People",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epDifferenceProjectedOnPop, "The deviation (difference) between annual projected population and population used for SRP membership lands.", "Pers","People",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epDifferenceProjectedOtherPop, "The deviation (difference) between annual projected population and population used for non-SRP membership lands.", "Pers","People",""));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epDifferenceTotalPop, "The deviation (difference) between annual total projected population and total population used ", "Pers","People",""));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epWaterAugmentation, "The annual amount of water supply available from a new source of water not included in the original water portfolio.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[1] { WaterSupplyGroup }));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epAWSAnnualGWLimit, "Indicates if the AWS rule to limit annual pumping to AWS designated annual credits should be applied (Code=0) or ignored (Code=1)", "Code","Code",""));
           ...
           //   "NNAA5678901234567890123456789012345                
                "% Effluent Used for Environment")); // "NNAA5678901234567890123456789012345"));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epWebPop_GrowthRateAdj_PCT, "Adjustes the population growth rate for all water providers on a scale of 0-150, with 0-no growth to 150-50% increase in growth rate", "0-150","0-0% to 150-150%",
                "% Change in Projected Growth Rate"));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epWaterAugmentationUsed, "Amount of water that is used from augmented water supplies.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[1] { WaterSupplyGroup }));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epTotalReclaimedCreated_AF, "The total amount of reclaimed water that was produced.", "AF/yr", "Acre Feet per Year", new ModelParameterGroupClass[1] { WaterSupplyGroup }));

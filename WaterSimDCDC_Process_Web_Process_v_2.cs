...
namespace WaterSimDCDC.Processes
{
    ...
    public class AgtoMuniWebFeedbackProcess : WaterSimDCDC.AnnualFeedbackProcess
    {
        ...
        public override void CleanUp()
        {
            if (this.FWsim != null)
            {
              ...
              //  this.FWsim.ParamManager.DeleteParameter(eModelParam.epAgSustainabilityIndicator);
            }
        }
    ...
    public class Env_WebFeedbackProcess : WaterSimDCDC.AnnualFeedbackProcess
    {
        ...
        public Env_WebFeedbackProcess(WaterSimManager WSim)
            : base("Water for Environment")
        {
            FetchValuesForEnv(WSim);
            CreateEZnvSustainParameter(WSim);
        }
        ...
        void CreateEZnvSustainParameter(WaterSimManager WSim)
        {
            this.FWsim = WSim;
           // WSim.ParamManager.AddParameter(new ModelBaseOutputParameterClass(eModelParam.epEnvIndTemp, "Env Sustinability Indicator", "SUSIDENVT", GetEnvIndicator ));
        ...
        public override void CleanUp()
        {
            ...
            {
                // OK clean up by delete this parameter
               // this.FWsim.ParamManager.DeleteParameter(eModelParam.epEnvIndTemp);
            }
        }

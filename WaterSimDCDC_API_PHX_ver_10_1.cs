...
namespace WaterSimDCDC
{
    ...
    {
        #region Fields_Constructor_Base_Methods and model dll
        ...
        protected override string GetModelVersion()
        {
            if (_ws != null)
            {
               // string _ModelBuild = _ws.get_Build + " " + _ws.get_TestVersion;
                string _ModelBuild = "WSP"+_ws.get_Build +  _ws.get_TestVersion;
                return _ModelBuild;
            }
            else
            {
        ...
        protected override void initialize_ModelParameters()
        {
          ...
          //  CreateModelOutputFiles = false;
            ...
            *************************************************************************/
            ...
            // DAS 01.26.16
            _pm.AddParameter(new ModelParameterClass(eModelParam.epProvider_DroughtScenarios, "Severity: " + chosenDrought, "DROUSCEN", rangeChecktype.rctCheckRange, 0, 4, geti_API_Drought_Scenario, seti_API_Drought_Scenario, RangeCheck.NoSpecialBase));
            //
            // 06.02.16 DAS
            ...
            PCT_AgWaterUsedToThresh = new providerArrayProperty(_pm, eModelParam.epProvider_AgWaterUsedvsThresh, get_AgWaterUsed_ratio, eProviderAggregateMode.agSum);
                //eProviderAggregateMode.agWeighted);
...
//            get { return Sim_EndYear;}// _Simulation_End_Year; }
    ...
    //
        ...
        internal void set_GPCDmin(int[] value) { if (!FModelLocked) holdMinGPCD = value; }

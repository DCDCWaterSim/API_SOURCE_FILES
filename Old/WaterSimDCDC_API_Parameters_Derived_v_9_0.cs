           ...
           public partial class WaterSimManager
           {
               ...
               private int[] get_PCT_GWofDemand()
               {
                   ...
                   for (int i = 0; i < GWofDemand.Length; i++)
                   {
                       ...
                       if (PDemand[i] > 0)
                           GWofDemand[i] = (GWPumped[i] * 100) / PDemand[i];
                   }
               ...
               partial void initialize_Derived_ModelParameters()
               {
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epTotalSupplyUsed, "Total Water Supply Used", "TOTSUPUSE", Total_Water_Supply_Used, _pm.DepWaterSupplyGroup, 0, 700000)); //modelParamtype.mptOutputProvider, rangeChecktype.rctNoRangeCheck, 0, 0, null, get_TotalSupply, null, null, null, null, Total_Water_Supply_Used));
                   // add Total_Water_Supply_Used 

...
namespace WaterSimDCDC
{
    ...
    public class ModelParameterGroupClass 
    {
        ...
        public ModelParameterGroupClass(string Name, ParameterManagerClass aParamManager)
        {
            FName = Name;
            FPM = aParamManager;
        }
        ...
        public ModelParameterGroupClass(string Name, ParameterManagerClass aParamManager, int[] eModelParamArray)
        {
            FName = Name;
            FPM = aParamManager;
        ...
        public ModelParameterGroupClass(string Name, ParameterManagerClass aParamManager, List<int> eModelParamList)
        {
            FName = Name;
            FPM = aParamManager;
    ...
    public class ModelParameterGroupManager
    {
        ...
        public ModelParameterGroupManager()
        {
        }
    ...
    public abstract class ModelParameterBaseClass : IDisposable
    {
        ...
        internal ModelParameterGroupClass FDerivedFrom;
        // List of model_parameters that depend on this parameter for there value
        internal ModelParameterGroupClass FDependOn;
        // List of model_parameters topic groups that this parameter is a member of
        internal List< ModelParameterGroupClass> FGroups = new List<ModelParameterGroupClass>();
        ...
        ///-------------------------------------------------------------------------------------------------
        /// <summary>   Gets the groups this model parameter belongs to. </summary>
        ///<remarks>Retuns and array of emodelparam values</remarks>
        /// <returns>   . </returns>
        ///-------------------------------------------------------------------------------------------------

        public ModelParameterGroupClass[] Groups()
        {
            ModelParameterGroupClass[] temp = new ModelParameterGroupClass[FGroups.Count];
    ...
    public class ModelParameterClass : ModelParameterBaseClass
    {
        ...
        /// <param name="aFieldname">       a fieldname. </param>
        /// <param name="Providerproperty"> The providerproperty. </param>
        /// <param name="DerivedGroup">     Group the derived belongs to. </param>
        /// <param name="TheGroups">        Groups the belongs to. </param>
        ///-------------------------------------------------------------------------------------------------

        public ModelParameterClass(int aModelParam, string aLabel, string aFieldname, providerArrayProperty Providerproperty, ModelParameterGroupClass DerivedGroup, ModelParameterGroupClass[] TheGroups)
            : base()
        {
            FModelParam = aModelParam;
            FLabel = aLabel;
            ...
            if (TheGroups != null)
            {
                foreach (ModelParameterGroupClass Grp in TheGroups)
                    FGroups.Add(Grp);
            }
        }
        ...
        public ModelParameterClass(int aModelParam, string aLabel, string aFieldname,
            rangeChecktype aRangeCheckType, int aLowRange, int aHighRange, Dget agetint, Dset asetint, DcheckBase specialBaseRangeCheck, ModelParameterGroupClass DerivedGroup, ModelParameterGroupClass[] TheGroups)
            : base()
        {
            FModelParam = aModelParam;
            FLabel = aLabel;
        ...
        ///-------------------------------------------------------------------------------------------------
        /// <summary>   Constructor for OutputBase Model Parameters. </summary>
        ///
        /// <param name="aModelParam">  a model parameter. </param>
        /// <param name="aLabel">       a label. </param>
        /// <param name="aFieldname">   a fieldname. </param>
    ...
    public class ParameterManagerClass
    {
        ...
        public ModelParameterGroupClass TotalEffluentGroup;
        /// <summary> A Model Parameter Group for Used Effluent. </summary>
        public ModelParameterGroupClass UsedEffluentGroup;
        /// <summary> A Model Parameter Group for Total Reclaimed. </summary>
        public ModelParameterGroupClass TotalReclaimedGroup;

        /// <summary> Manages ModelParameterGroups </summary>
        public ModelParameterGroupManager GroupManager = new ModelParameterGroupManager();
...
//             eModelParam.epReclaimed_Water_Used,
        ...
        internal void Setup()
        {
           ...
           ReclaimedGroup = new ModelParameterGroupClass("Reclaimed",this,reclaimedchecklist);
           EffluentGroup = new ModelParameterGroupClass("Effluent", this, effluentchecklist);
           WaterUseGroup = new ModelParameterGroupClass("WaterUse", this, wateruserchecklist);
           //----
           WaterSupplyGroup = new ModelParameterGroupClass("WaterSupply", this, watersupplylist);
           GroupManager.Add(WaterSupplyGroup);
           TotalEffluentGroup = new ModelParameterGroupClass("WaterSupply", this, Totaleffluentlist);
           GroupManager.Add(TotalEffluentGroup);
           UsedEffluentGroup = new ModelParameterGroupClass("WaterSupply", this, ReUsedeffluentlist);
           GroupManager.Add(UsedEffluentGroup);
           TotalReclaimedGroup = new ModelParameterGroupClass("Reclaimed", this, Totalreclaimedlist);
           GroupManager.Add(TotalReclaimedGroup);
        }
        ///-------------------------------------------------------------------------------------------------

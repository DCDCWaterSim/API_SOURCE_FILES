...
namespace WaterSimDCDC
{
    public partial class WaterSimManager
    {
        ...
        const string FileBuild = "03.07.14_15:32:00";
        ...
        partial void initialize_WebInterface_DerivedParameters()
        {
            ...
            this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epWebUIeffluent, "Effluent: return/reuse", "WEBEFPCT", rangeChecktype.rctCheckRange, 0, 100, geti_WebEffluent, seti_WebEffluent, RangeCheck.NoSpecialBase, EffGroup, null));
        ...
        private void setDefaultValues()
        {
            ...
            Web_PopulationGrowthRate_PCT = 120;

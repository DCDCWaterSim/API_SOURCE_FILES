           ...
           public partial class WaterSimManager : WaterSimManagerClass
           {
              ...
              /// </summary>
               ...
               private void initialize_ModelParameters()
               {
                   ...
                   // DAS Added 02.15.14
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epWaterAugmentationUsed, "Amount of Augmented Water Used", "WATAUGUSED", rangeChecktype.rctCheckRange, 0, 100000, RangeCheck.NoSpecialProvider, WaterAugmentationUsed));

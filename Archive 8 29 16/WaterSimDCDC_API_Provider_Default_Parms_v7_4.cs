     ...
     partial void initialize_Provider_Default_ModelParameters()   
        {
         ...
         //
            int[] min_alter_GPCD = new int[ProviderClass.NumberOfProviders] {
                    ...
                    70    , //0 ad :       Adaman_Mutual, (the remaining data come from the excell data sheet for the model)
                    70   , //1 wt :        White_Tanks, - used average from all data
                    70    , //2 pv :        Paradise_Valley,
                    70   , //3 su :        Sun_City,
                    70   , //4 sw :        Sun_City_West,
                    70   , //5 av :        Avondale,
                    70   , //6 be :        Berneil,
                    70   , //7 bu :        Buckeye,
                    70   , //8 cf :        Carefree,
                    70   , //9 cc :        Cave_Creek,
                    70   , //10 ch :        Chandler,
                    70   , //11 cp :        Chaparral_City,
                    70   , //12 sp :        Surprise,
                    70   , //13 cu :        Clearwater_Utiliti
                    70   , //14 dh :        Desert_Hills,
                    70   , //15 em :        El_Mirage,
                    70   , //16 gi :        Gilbert,
                    70   , //17 gl :        Glendale,
                    70   , //18 go :        Goodyear,
                    70   , //19 lp :        Litchfield_Park,
                    70   , //20 me :        Mesa,
                  // 50	 , //21 no :       No provider
                  // 50	 , //22 op :       Other Provider
                    70   , //23 pe :        Peoria,
                    70   , //24 ph :        Phoenix, - used data from a 4/23/12 document- GPCD city of phoenix 1990 to 2011
                    70   , //25 qk :        Queen_Creek,
                    70   , //26 rg :        Rigby,
                    70   , //27 rv :        Rio_Verde,
                    70   , //28 ry :        Rose_Valley,
                    70   , //29 sc :        Scottsdale,
                    70   , //30 sr :        Sunrise,
                    70   , //31 te :        Tempe,
                    70   , //32 to :        Tolleson,
                    70   , //33 vu :        Valley_Utilities,
                    70    //34 we :        West_End,   
                };
            ...
            double[] pct_alter_GPCD = new double[ProviderClass.NumberOfProviders] {
                     ...
                     1.855,    //0 ad :        Adaman_Mutual, (the remaining data come from the excell data sheet for the model)

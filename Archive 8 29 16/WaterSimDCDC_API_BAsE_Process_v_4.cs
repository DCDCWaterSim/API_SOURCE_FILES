...
namespace WaterSimDCDC
{
    ...
    public class AnnualFeedbackProcess // IDisposable
    {
       ...
       /// 			 however ther is no output data since the model has not yet been run (ie Output values are not meaningful)</remarks>
        ///-------------------------------------------------------------------------------------------------
        ...
        /// <remarks> Override this method to do some activity before each annual run.  The first year does not

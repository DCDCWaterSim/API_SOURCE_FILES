       ...
       namespace WaterSimDCDC
       {
           ...
           public partial class WaterSimManager : WaterSimManagerClass
           {
               ...
               const string _APIVersion = "9.2.3";  // latest version of API
              ...
              /// </summary>
               ...
               private void initialize_ModelParameters()
               {
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_Climate_Adjustment_Percent, "Colorado Climate Adjustment", "COCLMADJ",  rangeChecktype.rctCheckRange, 0, 150, geti_Colorado_Climate_Adjustment_Percent, seti_Colorado_Climate_Adjustment_Percent, RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_User_Adjustment_Percent, "Colorado Drought Adjustment", "COUSRADJ",  rangeChecktype.rctCheckRange, 0, 150, geti_Colorado_User_Adjustment_Percent, seti_Colorado_User_Adjustment_Percent, RangeCheck.NoSpecialBase));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Climate_Adjustment_Percent, "Salt-Verde Climate Adjustment", "SVCLMADJ",  rangeChecktype.rctCheckRange, 0, 150, geti_SaltVerde_Climate_Adjustment_Percent, seti_SaltVerde_Climate_Adjustment_Percent, RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_User_Adjustment_Percent, "Salt-Verde Drought Adjustment", "SVUSRADJ",  rangeChecktype.rctCheckRange, 0, 150, geti_SaltVerde_User_Adjustment_Percent, seti_SaltVerde_User_Adjustment_Percent, RangeCheck.NoSpecialBase));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epPCT_Alter_GPCD, "Reduction in GPCD, by 2085(% ;from 2010)", "PCRDGPCD",  rangeChecktype.rctCheckRange, 0, 75, geti_PCT_Reduce_GPCD, seti_PCT_Reduce_GPCD, RangeCheck.NoSpecialBase));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epUse_WaterSupply_to_DirectInject, "Water Supply to DirectInject (AF)", "USEWSDI", rangeChecktype.rctCheckRange, 0, 100000, RangeCheck.NoSpecialProvider,Use_WaterSupply_to_DirectInject));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epProvider_Max_NormalFlow, "The maximum right usable", "NFLOWMAX", modelParamtype.mptInputProvider, rangeChecktype.rctCheckRange, 90, 554, null, get_normalFlow_rights_max, null, set_normalFlow_rights_max, null, null, Maximum_normalFlow_rights));
                   // DAS Added 02.15.14
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epWaterAugmentationUsed, "Amount of Augmented Water Used", "WATAUGUSED", rangeChecktype.rctCheckRange, 0, 1000000, RangeCheck.NoSpecialProvider, WaterAugmentationUsed));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_To_Agriculture, "Effluent To Agriculture (AF)", "EFLAG", geti_Effluent_To_Agriculture, 0, 550000 ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Spillage, "Reservoir Spillage (AF)", "SVTSPILL", geti_SVTspillage, 0, 3500000 ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epMeadLevel, "Mead Elevation (FT)", "MEADELEV", geti_ElevationMead, 600, 1500));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalNaturalRecharge, "Regional Aquifer Natural Recharge (AF)", "REGAQRCHG", geti_Regional_Natural_Recharge, 100000, 1200000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalCAGRDRecharge, "Regional CAGRD Recharge (AF)", "REGCAGRDR", geti_Regional_CAGRD_Recharge, 0, 250000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalInflow, "Regional Natural Aquifer Inflow (AF)", "REGAQIN", geti_Regional_Inflow, 20000, 50000 ));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalProviderRecharge, "Total Recharge All Providers (AF)", "REGPRRCHG", geti_Regional_Provider_Recharge, 0, 1500 ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalAgOtherPumping, "Regional Ag and Other Pumping (AF)", "REGAOPMP", geti_Regional_Ag_Other_Pumping, 0, 700000 ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalOutflow, "Regional Aquifer Natural Outflow (AF)", "REGNAOUT", geti_Regional_Outflow, 30000, 40000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalGWBalance, "Regional Aquifer Balance (AF)", "REGAQBAL", geti_Regional_Groundwater_Balance, 50000000, 10000000 ));

                   
                   // Provider Outputs
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGroundwater_Pumped_Municipal, "Groundwater Pumped Municipal (AF)", "MGWPUMP", Groundwater_Pumped_Municipal, 0, 150000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGroundwater_Balance, "Available Groundwater (AF)", "GWAVAIL", Groundwater_Balance, 0, 7000000));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGroundwater_Bank_Used, "Groundwater Bank Used(AF)", "BNKUSED", Groundwater_Bank_Used, 0, 50000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGroundwater_Bank_Balance, "Groundwater Bank Balance (AF)", "BNKAVAIL", Groundwater_Bank_Balance, 0, 700000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epReclaimed_Water_Used, "Reclaimed Water Used (AF)", "RECTOT", Reclaimed_Water_Used, 0, 50000));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epReclaimed_Water_Discharged, "Reclaimed Water Discharged (AF)", "RECDISC", Reclaimed_Water_Discharged, 0, 50000));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_Reused, "Total Effluent Reused (AF)", "EFLCRT", Total_Effluent_Reused, 0, 250000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_To_Vadose, "Effluent To Vadose (AF)", "EFLVADOS", Effluent_To_Vadose, 0, 25000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_To_PowerPlant, "Effluent To PowerPlant (AF)", "EFLPP", Effluent_To_PowerPlant, 0, 85000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_Discharged, "Effluent Discharged (AF)", "EFLDISC", Effluent_Discharged, 0, 60000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epDemand_Deficit, "Demand Deficit (AF)", "DEMDEF", Demand_Deficit));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epTotal_Demand, "Total Demand (AF)", "TOTDEM", Total_Demand, 0, 500000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGPCD_Used, "GPCD Used", "GPCDUSED", GPCD_Used, 0, 400));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epPopulation_Used, "Population", "POPUSED", Population_Used, 1000, 4000000));
...
// DAS
                   ModelParameterGroupClass PopGroup = new ModelParameterGroupClass("DrillPopUsed", this.ParamManager, new int[2] { eModelParam.epOnProjectDemand, eModelParam.epOffProjectDemand });

                   _pm.AddParameter(new ModelParameterClass(eModelParam.epAnnualIncidental, "Incidental Recharge Credit (AF)", "INCCREDIT", Incidental_Water_Credit, 0, 75000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epVadoseToAquifer, "Total Vadose Recharge (AF)", "VADRCHTOT", Total_Vadose_To_Aquifer, 0, 150000));

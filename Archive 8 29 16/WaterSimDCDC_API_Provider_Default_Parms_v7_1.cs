     ...
     partial void initialize_Provider_Default_ModelParameters()   
        {
         ...
         //
            ...
            int[] pct_alter_GPCD = new int[ProviderClass.NumberOfProviders] {
                    ...
                    -1    , //0 ad :       Adaman_Mutual, (the remaining data come from the excell data sheet for the model)
                     -1   , //1 wt :        White_Tanks, - used average from all data
                    -1   , //2 pv :        Paradise_Valley,
                    -1   , //3 su :        Sun_City,
                     -1   , //4 sw :        Sun_City_West,
                    -1   , //5 av :        Avondale,
                     -1   , //6 be :        Berneil,
                    -1   , //7 bu :        Buckeye,
                     -1   , //8 cf :        Carefree,
                    -1   , //9 cc :        Cave_Creek,
                    -1   , //10 ch :        Chandler,
                     -1   , //11 cp :        Chaparral_City,
                    -1   , //12 sp :        Surprise,
                     -1   , //13 cu :        Clearwater_Utiliti
                     -1   , //14 dh :        Desert_Hills,
                     -1   , //15 em :        El_Mirage,
                     -1   , //16 gi :        Gilbert,
                     -1   , //17 gl :        Glendale,
                    -1   , //18 go :        Goodyear,
                    -1   , //19 lp :        Litchfield_Park,
                    -1   , //20 me :        Mesa,
                  // 0	 , //21 no :       No provider
                  // 0	 , //22 op :       Other Provider
                     -1   , //23 pe :        Peoria,
                    -1   , //24 ph :        Phoenix, - used data from a 4/23/12 document- GPCD city of phoenix 1990 to 2011
                     -1   , //25 qk :        Queen_Creek,
                     -1   , //26 rg :        Rigby,
                    -1   , //27 rv :        Rio_Verde,
                     -1   , //28 ry :        Rose_Valley,

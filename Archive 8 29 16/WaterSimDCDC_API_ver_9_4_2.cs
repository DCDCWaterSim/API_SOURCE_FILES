       ...
       //       Version 9.4.1
       //       12/3/14
       //       Based on Model_interface.cs version "09.08.14_14:33:00";
       ...
       //
       // Sampson 06.11.15,07.30.15,08.04.15
       //====================================================================================
       using System;
       ...
       namespace WaterSimDCDC
       {
           ...
           public partial class WaterSimManager : WaterSimManagerClass
           {
               ...
               const string _APIVersion = "9.4.2.2" ;  // latest version of API
               ...
               public bool _Dynamic_GPCD = false;
              // int[] GPCD_Original = new int[ProviderClass.NumberOfProviders];
               ...
               /// Note: For NUmit Testing purposes. NOT POSITIVE that this should remain public
               /// 01.12.15 DAS
               //internal WaterSimU _ws;  // this is the interface to fortran model
               public WaterSimU _ws;
               //----------------------------------------------------------------------------------------------------
               // Constructor
               /// <summary>
                   ...
                   ) : base()
               {
                   ...
                   GPCDFIX();
                    // 02.16.15 DAS commented this out
              ...
              /// </summary>
               ...
               //
               protected int Sim_RunYear
               {
                   get { int runYear = 2000 + _CurrentYear;
                   return runYear; } }
               ...
               // ------------------------------------------- 
               // 10.07.15 DAS
               //public bool DynamicGPCDestimates
               //{ get { return _Dynamic_GPCD; } set { _Dynamic_GPCD = value; } }
               ...
               #region ClassInitialization
                   ...
                   //----------------------------------------------------------------------------------------------------
                   // 09.02.15
                   partial void initialize_DecisionGame_ModelParameters();
                   //----------------------------------------------------------------------------------------------------
                   // 10.07.15
                   partial void initialize_dynamicGPCD();
                   ...
                   private void initialize_ModelParameters()
                   {
                       ...
                       #region ProviderArray Input properties
                           ...
                           //
                           // -------------------------------------------------
                           // DAS moved here from User_Modes_2.cs
                           // 09.02.15
                          ...
                          // Provider_GPCD_Slope = new providerArrayProperty(_pm, eModelParam.epProvider_GPCDslope, get_GPCDslope, set_GPCDslope, eProviderAggregateMode.agWeighted);

                           // End of moved
                           // -------------------------------------------------

                           Error_Check_OnMetBandC = new providerArrayProperty(_pm, eModelParam.epProvider_DataCheckOnMetBandC, get_errorCheckOnMetBandC, eProviderAggregateMode.agNone);
                           Error_Check_OffMetGW = new providerArrayProperty(_pm, eModelParam.epProvider_DataCheckOffMetGW, get_errorCheckOffMetGW, eProviderAggregateMode.agNone);

                            //
                       #endregion

                       // Initialize Model ProviderArray Output properties
                       #region Init ProviderArray Output properties
                           ...
                           CAP_LossPotential_PriorityFive = new providerArrayProperty(_pm, eModelParam.epCAP_LossPotential_Priority5, get_CAPshortages_PriorityFive, eProviderAggregateMode.agSum);
                            //
                           CAP_RightsNotMet_PriorityFour = new providerArrayProperty(_pm, eModelParam.epCAP_RightsNotMet_Priority4, get_CAPrightsNotMet_PriorityFour, eProviderAggregateMode.agSum);
                           CAP_RightsNotMet_PriorityFive = new providerArrayProperty(_pm, eModelParam.epCAP_RightsNotMet_Priority5, get_CAPrightsNotMet_PriorityFive, eProviderAggregateMode.agSum);
                           //
                           CAP_Avail_forWBPriorityFour = new providerArrayProperty(_pm, eModelParam.epCAP_availForWB_Priority4, get_CAPunused_PriorityFour, eProviderAggregateMode.agSum);
                           CAP_Avail_forWBPriorityFive = new providerArrayProperty(_pm, eModelParam.epCAP_availForWB_Priority5, get_CAPunused_PriorityFive, eProviderAggregateMode.agSum);
                       ...
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_Historical_Extraction_Start_Year, "Colorado Flow Trace Start Year", "COEXTSTYR",  rangeChecktype.rctCheckRangeSpecial, 762, 1980, geti_Colorado_Historical_Extraction_Start_Year, seti_Colorado_Historical_Extraction_Start_Year, ColoradoYearRangeCheck));
                       ...
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_User_Adjustment_StartYear, "Colorado Drought Start Year", "COUSRSTR",  rangeChecktype.rctCheckRange, 2013, 2081, geti_Colorado_User_Adjustment_StartYear, seti_Colorado_User_Adjustment_StartYear,RangeCheck.NoSpecialBase));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_User_Adjustment_Stop_Year, "Colorado Drought Stop Year", "COUSRSTP",  rangeChecktype.rctCheckRange, 2013, 2085, geti_Colorado_User_Adjustment_Stop_Year, seti_Colorado_User_Adjustment_Stop_Year, RangeCheck.NoSpecialBase));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Historical_Extraction_Start_Year, "SaltVerde Flows Trace Start Year", "SVEXTSTYR",  rangeChecktype.rctCheckRangeSpecial, 1330, 1980, geti_SaltVerde_Historical_Extraction_Start_Year, seti_SaltVerde_Historical_Extraction_Start_Year, SaltVerdeYearRangeCheck));
                       ...
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_User_Adjustment_Start_Year, "Salt-Verde Drought Start Year", "SVUSRSTR",  rangeChecktype.rctCheckRange, 2013, 2081, geti_SaltVerde_User_Adjustment_Start_Year, seti_SaltVerde_User_Adjustment_Start_Year, RangeCheck.NoSpecialBase));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_User_Adjustment_Stop_Year, "Salt-Verde Drought Stop Year", "SVUSRSTP",  rangeChecktype.rctCheckRange, 2013, 2085, geti_SaltVerde_User_Adjustment_Stop_Year, seti_SaltVerde_User_Adjustment_Stop_Year, RangeCheck.NoSpecialBase));
                       ...
                       // Provider Inputs
                       #region PI
                        // change range checking on this parameter today 05.19.15 DAS
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epAlterGPCDpct, "Alter the provider trend in GPCD", "ALTRGPCD", modelParamtype.mptInputProvider, rangeChecktype.rctCheckRange, -95, 95, null, get_alterGPCDpct, null, set_alterGPCDpct, null, null, PCT_alter_GPCD));
                       ...
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epSurface_to_Vadose_Time_Lag, "Surface to Vadose Time Lag in Years", "VADLAG", rangeChecktype.rctCheckRange, 0, 300, RangeCheck.NoSpecialProvider,Surface_to_Vadose_Time_Lag));
                       ...
                       //
                      // _pm.AddParameter(new ModelParameterClass(eModelParam.epAlterGPCDslope, "The slope of GPCD", "GPCDSLOPE", modelParamtype.mptInputProvider, rangeChecktype.rctCheckRange, -10, 10, null, get_GPCDslope, null, set_GPCDslope, null, null, Provider_GPCD_Slope));
                       ...
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltTonto_AnnualFlow, "Salt/Tonto River Flow", "STRFLOW", geti_SaltTonto_River_Flow, 0, 5000000));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epVerde_AnnualFlow, "Verde River Flow", "VRFLOW", geti_Verde_River_Flow, 0, 5000000));
                      ...
                      // _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalGWBalance, "Regional Aquifer Balance", "REGAQBAL", geti_Regional_Groundwater_Balance, 50000000, 10000000 ));
                       ...
                       //
                       // temp
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epAlterGPCDdifference, "Testing", "GPCDTEST", geti_GPCD_Difference, 0, -1200000));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epAlterGPCDslope, "Testing", "GPCDSLOPE", geti_GPCD_Slope, 0, -1200000));
                       ...
                       //
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Annual_GW_Deliveries_SRP, "SRP Groundwater Pumping", "SRPGW", SaltVerde_Annual_GW_Deliveries_SRP, 0, 400000));
                       //
                       ...
                       // DAS 08.04.15 
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epCAP_RightsNotMet_Priority4, "CAP Demand Not Met Priority Four", "CAPRTSNMP4", CAP_RightsNotMet_PriorityFour, 0, 300000));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epCAP_RightsNotMet_Priority5, "CAP Demand Not Met Priority Five", "CAPRTSNMP5", CAP_RightsNotMet_PriorityFive, 0, 300000));
                       // -------------------------------------------------
                       // DAS moved here from User_Modes_2.cs
                       // 09.02.15
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epProvider_GPCDres, "Residential GPCD", "GPCDRES", GPCD_Res, 0, 300));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epProvider_GPCDcomInd, "Com and Ind GPCD", "GPCDCOMIND", GPCD_ComInd, 0, 500));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epProvider_AgWaterPumped, "Agricultural Water Pumped", "AGPUMPED", Gross_Agriculture_WaterPumped_AF, 0, 400000));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epProvider_AgWaterUsedvsThresh, "Ag Water Used Relative to Threshold", "AGUSEDPCT", PCT_AgWaterUsedToThresh, 0, 100));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Annual_SurfaceDeliveries_SRP, "Salt-Verde Surface Water", "SRPSURF", SaltVerde_Annual_SurfaceDeliveries_SRP, 0, 1000000));
                       ...
                       // ==========================
                        //
                       // DAS 09.04.15
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epProvider_DataCheckOnMetBandC, "Check On Project CAP Demand Met", "CHECKCAP", Error_Check_OnMetBandC, 0, 100000));
                       _pm.AddParameter(new ModelParameterClass(eModelParam.epProvider_DataCheckOffMetGW, "Check Off Project GW Demand Met", "CHECKGW", Error_Check_OffMetGW, 0, 100000));
                       ...
                       // DG 09.02.15
                       initialize_DecisionGame_ModelParameters();
                       // Call for Web Parameters
                       initialize_WebInterface_DerivedParameters();
                       // 10.07.15 das
                       initialize_dynamicGPCD();
                   }
                   //--------------------------------------------------------------     
                   #region InitDefault & GPCDFIX
                       private void InitDefaultVariables()
                       {
                           ...
                           /// FIND OUT WHAT HAPPEND to this
                           //COdeltaBurdenToAZ = false;
                           //
                       ...
                       internal void runBase()
                       {
                           Simulation_Initialize();
                           Simulation_Start_Year = 2000;
                           Simulation_End_Year = BaseYear;
                           Simulation_NextYear();
                            //// OK now fetch the GCPD defaults
                       }
               ...
               ----------------------------------------------------------- */
               {
                   ...
                   if ((_simulationStarted)&(!_inSimulationNextYear))
                   {
                       ...
                       // OK, Not the first year, inc the year;
                           { _CurrentYear++; }
               ...
               //----------------------------------------------------------------
               public virtual int Simulation_BaseYearParameter()
               /* --------------------------------------------------------
                * Returns the year run, if has already run last year, returns 0;
                * Calls close files afer running last year
               ----------------------------------------------------------- */
               ...
               internal virtual bool runYear(int year)
               ...
               ///  10.07.15 das
               /// </summary>
               //public providerArrayProperty GPCD_original;
               //internal void set_OriginalGPCD(int[] value) { if (!FModelLocked) GPCD_Original = value; }
               //internal int[] get_OriginalGPCD() { return GPCD_Original; }
               ...
               private int[] get_CAPrightsNotMet_PriorityFour()
               { return _ws.get_CAPdemandNotMetPriority4; }

               /// <summary>  </summary>
               ///<remarks> Units AF</remarks>
               /// <seealso cref="Groundwater_Bank_Used"/>
               public providerArrayProperty CAP_RightsNotMet_PriorityFour;
               //---------------------------------------
               //---------------------------------------
               private int[] get_CAPrightsNotMet_PriorityFive()
               { return _ws.get_CAPdemandNotMetPriority5; }

               /// <summary>  </summary>
               ///<remarks> Units AF</remarks>
               /// <seealso cref="Groundwater_Bank_Used"/>
               public providerArrayProperty CAP_RightsNotMet_PriorityFive;
               ///
               private int[] get_CAPunused_PriorityFour()
               { return _ws.get_CAPp4Available; }

               /// <summary>  </summary>
               ///<remarks> Units AF</remarks>
               /// <seealso cref="Groundwater_Bank_Used"/>
               public providerArrayProperty CAP_Avail_forWBPriorityFour;
               //---------------------------------------
               //---------------------------------------
               private int[] get_CAPunused_PriorityFive()
               { return _ws.get_CAPp5Available; }

               /// <summary>  </summary>
               ///<remarks> Units AF</remarks>
               /// <seealso cref="Groundwater_Bank_Used"/>
               public providerArrayProperty CAP_Avail_forWBPriorityFive;
               ...
               // No initialization code for this model parameter
               // 10.05.15 DAS So, cannot now be used
               /// <summary>
               /// 
               /// </summary>
               /// <returns></returns>
              ...
              //----------------------------------
               ...
               //-----------------------------------------------------------------------------------------------
               private int[] get_GPCD_Res() { return _ws.get_ProviderGPCDres; }
               ...
               private int[] get_AgWaterUsed_ratio() { return _ws.get_AgWaterUsedRelativeTo2014_PCT; }
               ...
               internal int[] get_errorCheckOnMetBandC()
               { return _ws.errorCheckDataOnMetBandC; }

               //*********
               /// <summary> Provider Error Checking On Project Groundwater used</summary>
               /// <remarks>Used with the stress testing program to maintain consistency </remarks>
               //
               public providerArrayProperty Error_Check_OnMetBandC;

               //-----------------------------------------------------------------------------------------------
               internal int[] get_errorCheckOffMetGW()
               { return _ws.errorCheckDataOffMetGW; }

               //*********
               /// <summary> Provider Error Checking On Project Groundwater used</summary>
               /// <remarks>Used with the stress testing program to maintain consistency </remarks>
               //
               public providerArrayProperty Error_Check_OffMetGW;
               ...
               * ****************************************************************/
               ...
               public int Simulation_End_Year
               {
                   ...
                   {
                       // DAS 11.10.15
                       if (Sim_CurrentYear != _ws.Startyear)
                       {
                           SimulationLock = false;
                       }
                       if ((!_inRun) & (!FModelLocked))
         ...
         //
              ...
              //
               ...
               /// </summary>
               /// 10.07.15 DAS I changed the get to a memory stored value instead
               /// of coming out of the model
               private int[] providerMinGPCD = new int[ProviderClass.NumberOfProviders];
               public providerArrayProperty Provider_GPCD_Min;
              internal void set_GPCDmin(int[] value)
              {
                  if (!FModelLocked)
                  {
                      for (int i = 0; i < ProviderClass.NumberOfProviders; i++)
                      {
                          providerMinGPCD[i] = value[i];
                      }
              ...
              internal int[] get_GPCDmin() { return providerMinGPCD; }
            //  internal int[] get_GPCDmin() { return _ws.ProviderGPCDmin; }

              public double[] providerGPCDslope = new double[ProviderClass.NumberOfProviders];
              //public providerArrayProperty Provider_GPCD_Slope;
              internal void set_GPCDslope(double[] value)
              {
                  if (!FModelLocked)
                  {
                      for (int i = 0; i < ProviderClass.NumberOfProviders; i++)
                      {
                          providerGPCDslope[i] = value[i];
                      }
              ...
              internal double[] get_GPCDslope() { return providerGPCDslope; }
              ...
              //*********
               ...
               //
               private int geti_GPCD_Difference() { return AlterGPCD_Difference; }
               private int geti_GPCD_Slope() { return AlterGPCD_Slope; }
               ...
               //
               // ========================================
               // Moved here from User_Mods_2 on 09.02.15
               // DAS
               ...
               //
               private void seti_COdeltaBurdenRatioForAZ(int value)  { COdeltaBurdenRatioForAZ = value;  }

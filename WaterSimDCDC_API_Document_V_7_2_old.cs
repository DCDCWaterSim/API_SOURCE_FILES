...
//            WaterSimDescripItem DI = MPDesc.Find(delegate(WaterSimDescripItem Item) { return (Item.ModelParam == modelparam); });
        ...
        internal void BuildDescripList()
        {
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epWebWaterBankPCT, "Store this percent of excess surface water in a longerterm water bank.", "%", "Percentage", "% Excess Water to Bank",new string[] {},new int[] {}, new ModelParameterGroupClass[] { PolicyGroup, UrbanSystemGroup, Policy_UrbanSystem_Group }));
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epEnvironmentalFlow_PCT, "Allocates water for envirionmental use by leaving it in the rivers based on a scale of 0 to 100, wiith 0=no water and 100=500,000 AF/yr.", "0-100", "0=0 af/yr to 100=500,000 af/yr", "",new string[] {},new int[] {}, new ModelParameterGroupClass[] { PolicyGroup, UrbanSystemGroup, Policy_UrbanSystem_Group }));
            ...
            MPDesc.Add(new WaterSimDescripItem(eModelParam.epWebReclaimedWater, "Sets Regional Wastewater to Reclaimed Values for all providers", "%", "% Wastewater Reclaimed", "% of Wastewater Reclaimed", new string[] { }, new int[] { }, new ModelParameterGroupClass[] { PolicyGroup, UrbanSystemGroup, Policy_UrbanSystem_Group }));

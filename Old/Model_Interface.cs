...
namespace WaterSimDCDC
{
    ...
    public class WaterSimU : IDisposable
    {
        ...
        /// </summary>
        const string FileBuild =  "12.18.13_12:01:00";
        //
            ...
            /// </summary>
             ...
             //
             private const int RateResLeakagePct = 5; // i.e. 5.3%
             ...
             public WaterSimU(string Data, string Outputs, bool Write)
            {
               ...
               // writeLog = true;
                ...
                string start;
                mBuild = "WaterSim " + BuildNum_().ToString() + "." + BuildVer_() + " ";
                start = "WaterSim " + BuildNum_().ToString() + "." + BuildVer_() + " ";
                // DAS 05.18.12
                myBuild = get_TestVersion;
                mBuild = start + "-" + myBuild;
                //
                ...
                //
                ResetAll();
                bool Mycatch = get_ValidModelRun;
                if (!Mycatch)
                {
                    throw new Interface_Exception(0);
                }
            ...
            #endregion
            //-----------------------------------------------------------------------------------//
            #region FORTRAN ErrorCodes: summary
            /// <summary>
            ...
            ///  When MODFLOW is used. One must uncomment the lines to use the 
            ///  code. 
            /// </summary>
            ...
            /// </summary>
            protected internal int get_CAP
            {
                get
                {
                    int gvalue = 0;
            ...
            #endregion
            //-----------------------------------------------------------------------------------//
            #region Groundwater Variables:County scale-Not used, really: summary
            // ===================================
            //
            ...
            /// 
            /// NOT currently connected or Implemented!!!!!
            /// </summary>
            ...
            // This is the combined CO, Salt, and Verde
            //protected internal int FlowForEnvironment
            //{
            //    get
            //    {
            //        int gvalue = 0;
            //        return getWaterToEvironment_(ref gvalue);
            //    }
            //    set
            //    {
            //        int checkedValue = value;
            //        setWaterToEvironment_(ref checkedValue);
            //    }
            //}
            //[DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            //protected static extern int getWaterToEvironment_(ref int value);
            //[DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            //protected static extern void setWaterToEvironment_(ref int value);
            ...
            protected internal int set_AlterGPCDpct
            {
                set
                {
                    ...
                    setAlterGPCDPct_(ref checkedValue);
                }
            }
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            ...
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            protected static extern void getWaterBankingOption_(ref int count, int[] values);
            ...
            protected internal int set_WaterToAgriculture_AF
            {
                set
                {
                    int checkedValue = RangeCheckAg(value);
                    setWaterToAgricultureAF_(ref checkedValue);
                }
            }
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            protected static extern void setWaterToAgricultureAF_(ref int value);
            //
            ...
            internal double[] ShowersBathsMinPCD
            {
                get
                {
                    int num = cNumFortranProviders;
                    int[] myGet = new int[num];
                    getShowerBathPCD_(ref num, myGet);
            ...
            protected internal int[] get_GrayWaterResidential  // 
            {
                ...
                {
                    int num = cNumFortranProviders;
                    int[] get_GrayWaterResidential = new int[num];
                    getGrayWaterResidential_(ref num, get_GrayWaterResidential);
                    return TrimProvNames(get_GrayWaterResidential);
                }
            }
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            ...
            protected internal int[] get_ReclaimedWaterCreated  // 
            {
                ...
                {
                    int num = cNumFortranProviders;
                    int[] ReclaimedWaterOutput = new int[num];
                    getReclaimedWaterOut_(ref num, ReclaimedWaterOutput);
                    return TrimProvNames(ReclaimedWaterOutput);
                }
            }
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
        ...
        /// What, again, is this?
        /// </summary>
            protected internal int[] get_ReclaimedWaterDifference  // 
            {
                get
                {
                    int num = cNumFortranProviders;
                    int[] get_ReclaimedWaterDifference = new int[num];
                    getReclaimedDifference_(ref num, get_ReclaimedWaterDifference);
                    return TrimProvNames(get_ReclaimedWaterDifference);
                }
            }
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            protected static extern int getReclaimedDifference_(ref int count, int[] values);
            ...
            //
            // ---------------------------------------------------------------------------
            //  Annual deliveries of CO river water via get_CAP designations (acft a-1)
            //
            ...
            /// <summary>   Gets the annual verde river storage (AF). </summary>
            /// <value> The verde storage annual (from monthly data). </value>
            protected internal int get_VerdeStorageAnnual
            {
                get
                {
                    int gvalue = 0;
            ...
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            protected static extern int getVerdeStorage_(ref int value);
            //
            ...
            //   Provider surface water designations.  This includes get_CAP water but also surface water
            ...
            //
            //
            // trimmed to 33 - No reference found in the API code
            // 02.09.12 DAS
           ...
           [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            ...
            // get_CAP delivery (county scale) Deliveries into Maricopa County.
            //
            //   [CERTIFIED- 02.04.10 das]
            /// <summary>
    ...
    public class Interface_Exception : Exception
    {
        ...
        protected const string Pre = "WaterSim Interface Error: ";
    ...
    public static class Interface_strings
    {
        ...
        public const int NumberOfStrings = 2;

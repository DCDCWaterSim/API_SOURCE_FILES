       ...
       namespace WaterSimDCDC
       {
           ...
           public partial class WaterSimManager : WaterSimManagerClass
           {
               ...
               const string _APIVersion = "9.0.8";  // latest version of API
              ...
              /// </summary>
               ...
               private void initialize_ModelParameters()
               {
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_Historical_Extraction_Start_Year, "Colorado Historical ExtractionFlow Trace Start Year", "COEXTSTYR",  rangeChecktype.rctCheckRangeSpecial, 762, 1979, geti_Colorado_Historical_Extraction_Start_Year, seti_Colorado_Historical_Extraction_Start_Year, ColoradoYearRangeCheck));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_Climate_Adjustment_Percent, "Colorado Climate Adjustment %", "COCLMADJ",  rangeChecktype.rctCheckRange, 0, 300, geti_Colorado_Climate_Adjustment_Percent, seti_Colorado_Climate_Adjustment_Percent, RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_User_Adjustment_Percent, "Colorado UserDrought Adjustment %", "COUSRADJ",  rangeChecktype.rctCheckRange, 0, 300, geti_Colorado_User_Adjustment_Percent, seti_Colorado_User_Adjustment_Percent, RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_User_Adjustment_StartYear, "Colorado User AdjustmentDrought Start Year", "COUSRSTR",  rangeChecktype.rctCheckRange, 2006, 2081, geti_Colorado_User_Adjustment_StartYear, seti_Colorado_User_Adjustment_StartYear,RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_User_Adjustment_Stop_Year, "Colorado User AdjustmentDrought Stop Year", "COUSRSTP",  rangeChecktype.rctCheckRange, 2006, 2081, geti_Colorado_User_Adjustment_Stop_Year, seti_Colorado_User_Adjustment_Stop_Year, RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Historical_Extraction_Start_Year, "SaltVerde Historical ExtractionSVTonto Hist Flow Trace Start Year", "SVEXTSTYR",  rangeChecktype.rctCheckRangeSpecial, 1330, 1979, geti_SaltVerde_Historical_Extraction_Start_Year, seti_SaltVerde_Historical_Extraction_Start_Year, SaltVerdeYearRangeCheck));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Historical_Data, "SaltVerde HistoricalSVerdeTonto Hist Data Source", "SVSRC",  rangeChecktype.rctCheckRange, 1, 3, geti_SaltVerde_Historical_Data, seti_SaltVerde_Historical_Data, RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Climate_Adjustment_Percent, "SaltVerdeSVerdeTonto Climate Adjustment %", "SVCLMADJ",  rangeChecktype.rctCheckRange, 0, 300, geti_SaltVerde_Climate_Adjustment_Percent, seti_SaltVerde_Climate_Adjustment_Percent, RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_User_Adjustment_Percent, "SaltVerde UserSVerdeTonto Drought Adjustment %", "SVUSRADJ",  rangeChecktype.rctCheckRange, 0, 300, geti_SaltVerde_User_Adjustment_Percent, seti_SaltVerde_User_Adjustment_Percent, RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_User_Adjustment_Start_Year, "SaltVerde User AdjustmentSVerdeTonto Drought Start Year", "SVUSRSTR",  rangeChecktype.rctCheckRange, 2006, 2081, geti_SaltVerde_User_Adjustment_Start_Year, seti_SaltVerde_User_Adjustment_Start_Year, RangeCheck.NoSpecialBase));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_User_Adjustment_Stop_Year, "SaltVerde User AdjustmentSVerdeTonto Drought Stop Year", "SVUSRSTP",  rangeChecktype.rctCheckRange, 2006, 2081, geti_SaltVerde_User_Adjustment_Stop_Year, seti_SaltVerde_User_Adjustment_Stop_Year, RangeCheck.NoSpecialBase));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epPCT_Alter_GPCD, "Annual % Reduction in GPCD, by 2085(% ;from 2010)", "PCRDGPCD",  rangeChecktype.rctCheckRange, 0, 75, geti_PCT_Reduce_GPCD, seti_PCT_Reduce_GPCD, RangeCheck.NoSpecialBase));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epAlterGPCDpct, "Alter the provider trend in initial GPCD", "ALTRGPCD", modelParamtype.mptInputProvider, rangeChecktype.rctCheckRange, -70, 70, null, get_alterGPCDpct, null, set_alterGPCDpct, null, null, PCT_alter_GPCD));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epPCT_Reclaimed_to_RO, "% Reclaimed to RO", "PCRECRO", rangeChecktype.rctCheckRangeSpecial, 0, 100, PCTReclaimedRangeCheck,PCT_Reclaimed_to_RO));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSurfaceWater__to_Vadose, "SurfaceWater  to Vadose (AF)", "PCSWVAD", rangeChecktype.rctCheckRange, 0, 100000, RangeCheck.NoSpecialProvider,SurfaceWater__to_Vadose));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epUse_SurfaceWater_to_WaterBank, "SurfaceWater to WaterBank (AF)", "SWWB", rangeChecktype.rctCheckRange, 0, 100000, RangeCheck.NoSpecialProvider,Use_SurfaceWater_to_WaterBank));
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epPCT_WaterSupply_to_Commercial, "% WaterSupply to Commercial", "PCWSCOM", rangeChecktype.rctCheckRange, 0, 100, ResComPCTRangeCheck,PCT_WaterSupply_to_Commercial));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epUse_WaterSupply_to_DirectInject, "Water Supply for DirectInject (AF)", "USEWSDI", rangeChecktype.rctCheckRange, 0, 100000, RangeCheck.NoSpecialProvider,Use_WaterSupply_to_DirectInject));
                   ...
                   //*************
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epModfyNormalFlow, "Modify Normal Flow", "MNFLOW", rangeChecktype.rctCheckRange, 0, 55, RangeCheck.NoSpecialProvider, PCT_modify_normalFlow));
                   ...
                   // QUAY Added 3/6/13
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epWaterAugmentation, "Amount of Augmented Water", "WATAUG", rangeChecktype.rctCheckRange, 0, 1000000, RangeCheck.NoSpecialProvider, WaterAugmentation));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epProvider_Max_NormalFlow, "The maximum right usable", "NFLOWMAX", modelParamtype.mptInputProvider, rangeChecktype.rctCheckRange, 0, 500, null, get_normalFlow_rights_max, null, set_normalFlow_rights_max, null, null, Maximum_normalFlow_rights));
                   //
                   ...
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_River_Flow, "Colorado River Flow (AF)", "CORFLOW", geti_Colorado_River_Flow, 5000000, 30000000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epPowell_Storage, "Powell Storage (AF)", "POWSTORE", geti_Powell_Storage, 5000000, 30000000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epMead_Storage, "Mead Storage (AF)", "MEDSTORE", geti_Mead_Storage, 5000000, 30000000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_River_Flow, "SaltVerde River Flow (AF)", "SVRFLOW", geti_SaltVerde_River_Flow, 0, 5000000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Storage, "SaltVerde Storage (AF)", "SVRSTORE", geti_SaltVerde_Storage, 500000, 2500000));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_To_Agriculture, "Effluent To Agriculture (AF)", "EFLAG",  geti_Effluent_To_Agriculture ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Spillage, "Reservoir Spillage (AF)", "SVTSPILL", geti_SVTspillage ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epMeadLevel, "Mead Elevation (FT)", "MEADELEV",  geti_ElevationMead ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalNaturalRecharge, "Regional Aquifer Natural Recharge (AF)", "REGAQRCHG", geti_Regional_Natural_Recharge ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalCAGRDRecharge, "Regional CAGRD Recharge (AF)", "REGCAGRDR", geti_Regional_CAGRD_Recharge ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalInflow, "Regional Natural Aquifer Inflow (AF)", "REGAQIN", geti_Regional_Inflow ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalAgToVadose, "Regional Ag to Vadose Recharge (AF)", "REGAGVAD", geti_Regional_Ag_To_Vadose ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalProviderRecharge, "Total Recharge All Providers (AF)", "REGPRRCHG", geti_Regional_Provider_Recharge ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalAgOtherPumping, "Regional Ag and Other Pumping (AF)", "REGAOPMP", geti_Regional_Ag_Other_Pumping ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalOutflow, "Regional Aquifer Natural Outflow (AF)", "REGNAOUT", geti_Regional_Outflow ));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRegionalGWBalance, "Regional Aquifer Balance (AF)", "REGAQBAL", geti_Regional_Groundwater_Balance ));

                   
                   // Provider Outputs
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGroundwater_Pumped_Municipal, "Groundwater Pumped Municipal (AF)", "MGWPUMP",  Groundwater_Pumped_Municipal));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGroundwater_Balance, "Available Groundwater (AF)", "GWAVAIL",  Groundwater_Balance));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Annual_Deliveries_SRP, "SaltVerde Annual Deliveries SRP", "SRPDELIV", SaltVerde_Annual_Deliveries_SRP));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epSaltVerde_Class_BC_Designations, "SaltVerde Class BC Designations", "SRPBCDES", SaltVerde_Class_BC_Designations));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epColorado_Annual_Deliveries, "Colorado Annual Deliveries", "COLDELIV",  Colorado_Annual_Deliveries));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGroundwater_Bank_Used, "Groundwater Bank Used (AF)", "BNKUSED", Groundwater_Bank_Used));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGroundwater_Bank_Balance, "Groundwater Bank Balance (AF)", "BNKAVAIL", Groundwater_Bank_Balance));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epReclaimed_Water_Used, "Reclaimed Water Used (AF)", "RECTOT",  Reclaimed_Water_Used));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epReclaimed_Water_To_Vadose, "Reclaimed Water To Vadose (AF)", "RECVADOS", Reclaimed_Water_To_Vadose));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epReclaimed_Water_Discharged, "Reclaimed Water Discharged (AF)", "RECDISC", Reclaimed_Water_Discharged));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epReclaimed_Water_to_DirectInject, "Reclaimed Water to DirectInject (AF)", "RECINJEC", Reclaimed_Water_to_DirectInject));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRO_Reclaimed_Water_Used, "RO Reclaimed Water Used (AF)", "ROTOT", RO_Reclaimed_Water_Used));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epRO_Reclaimed_Water_to_DirectInject, "RO Reclaimed DirectInject (AF)", "ROINJEC", RO_Reclaimed_Water_to_DirectInject));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_Reused, "Total Effluent Reused (AF)", "EFLCRT",  Total_Effluent_Reused));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_To_Vadose, "Effluent To Vadose (AF)", "EFLVADOS", Effluent_To_Vadose));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_To_PowerPlant, "Effluent To PowerPlant (AF)", "EFLPP", Effluent_To_PowerPlant));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epEffluent_Discharged, "Effluent Discharged (AF)", "EFLDISC",  Effluent_Discharged));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epDemand_Deficit, "Demand Deficit (AF)", "DEMDEF", Demand_Deficit));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epTotal_Demand, "Total Demand (AF)", "TOTDEM", Total_Demand)); 
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epGPCD_Used, "GPCD Used", "GPCDUSED", GPCD_Used));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epPopulation_Used, "Population", "POPUSED", Population_Used));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epOnProjectDemand, "On Project Demand (AF)", "ONDEM", Demand_On_Project));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epOffProjectDemand, "Off Project Demand (AF)", "OFFDEM", Demand_Off_Project));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epOnProjectPopulation, "On-project population (ppl)", "POPONPRJ", Population_On_Project));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epOtherPopulation, "Other population (ppl)", "POPOTHER", Population_Other));
       
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epAnnualIncidental, "Incidental Recharge Credit (AF)", "INCCREDIT", Incidental_Water_Credit));
                   _pm.AddParameter(new ModelParameterClass(eModelParam.epVadoseToAquifer, "Total Vadose Recharge (AF)", "VADRCHTOT", Total_Vadose_To_Aquifer));

                   this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epTWWTPCreated_AF, "Total TWWTP Water Created", "TWWTP", Total_WWTP_Effluent));
                   this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epGPCDraw, "GPCD raw", "GPCDRAW", GPCD_raw));
                   this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epTotalReclaimedCreated_AF, "Reclaimed Water Created", "TOTREC", Reclaimed_Water_Created));
       ...
       //                        AS_Results.BaseOutput[ob_index] = MP.Value;
             ...
             public  class RiverRange
              ...
              /// <returns></returns>
               ...
               {
                   if ((Value == int.MinValue) && (errMessage.ToUpper() == "INFO"))
                   {
                        ModelParameterGroupClass GroupCodes = new ModelParameterGroupClass("SaltVerdeRange", ParamManager, new  int[2] {eModelParam.epColorado_Historical_Data_Source, aModelParameter.ModelParam} );
              ...
              /// <returns>true if year is valid, false otherwise </returns>
               ...
               internal bool SaltVerdeYearRangeCheck(int Value, ref string errMessage, ModelParameterBaseClass aModelParameter)
               {
                   if ((Value == int.MinValue) && (errMessage.ToUpper() == "INFO"))
                   {
                       ModelParameterGroupClass GroupCodes = new ModelParameterGroupClass("SaltVerdeRange", ParamManager, new  int[2] {eModelParam.epSaltVerde_Historical_Data,aModelParameter.ModelParam});
                       errMessage = BuildModelParameterGroupFieldList(aModelParameter.ParameterManager, GroupCodes, "Different Range for each source");
                       return true;
                   }
                   else
              ...
              //-----------------------------------------------
               ...
               internal static bool PCTEffluentRangeCheck(int Value, eProvider provider, ref string errMessage, ModelParameterBaseClass MP)
               {
                   ...
                   else
                   {
                       ...
                       bool valid = ((Value <= 100) & (Value >= 0) & (total <= 100));

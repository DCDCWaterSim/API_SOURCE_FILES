...
namespace WaterSimDCDC
{
    ...
    public class WaterSimU : IDisposable
    {
      ...
      //  const string FortranDLLFilename = "WaterSimDCDC_6.dll";

        //==========================================
        /// <summary>
        /// File build.  Updated when changes are made to the file.
        /// </summary>
        const string FileBuild =  "07.30.15_13:36:00";
        //
          ...
          //
            ...
            protected internal int[] get_GrossAgricultureWaterPumped_AF
            {
                ...
                get
                {
                    ...
                    getWaterFromAgPumpingTotal_(ref num, AgricultureWater_AF);
        ...
        /// </summary>
            ...
            /// <summary>
            /// 01.30.15
            ///  THe percentage of credits that can be transfered from Ag to Muni
            ///  NOT USED
            /// </summary>
            public int get_AgPumpingTotal_AF
            {

                get
                {
                    int myValue=0;
                    return getWaterFromAgPumpingTotal_(ref myValue);
                }
            }
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            protected  static extern int getWaterFromAgPumpingTotal_(ref int value);
            //
           /// <summary>
           ...
           /// </summary>
            protected internal int[] get_AgWaterUsedRelativeTo2014_PCT
            {
                ...
                get
                {
                    ...
                    getAgWaterToPotential_PCT_(ref num, AgricultureWaterRatio_PCT);
        ...
        /// </summary>
            ...
            protected internal int[] get_ColoradoUnusedPriority4  // af for the year by provider
            {
                get
                {
                    ...
                    // QUAY EDIT 12 13 15, can find the right DLL for this
                    // getCOunusedPriority4_(ref numProviders, get_ColoradoUnusedPriority4);
                    //---------------------------------
            ...
            protected internal int[] get_ColoradoUnusedPriority5  // af for the year by provider
            {
                get
                {
                    ...
                    // QUAY EDIT 12 13 15, can find the right DLL for this
                    //getCOunusedPriority5_(ref numProviders, get_ColoradoUnusedPriority5);
                    //---------------------------------
            ...
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            protected static extern void getCOunusedPriority5_(ref int count, int[] values);
            //
            // -------------------------------------------------------

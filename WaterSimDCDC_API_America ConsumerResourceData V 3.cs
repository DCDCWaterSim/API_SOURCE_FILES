...
namespace WaterSim_America
{
    ...
    public class CRF_Network
    {
        ...
        /// <remarks>   Allocates extra resources to COnsumers that need it</remarks>
        protected virtual void OptimizePhase2()
        {
            // see what total extra resources
            ...
            double NetRatio = XtraNeeded / FResources.Allocated;

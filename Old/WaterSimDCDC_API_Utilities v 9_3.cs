...
namespace WaterSimDCDC
{
    ...
    public class eModelParam
    {
        ...
        public const int epProvider_WaterFromAgPumping = 101;
        public const int epProvider_WaterFromAgSurface = 102;
        public const int epProvider_WaterFromAgPumpingMax = 103;
        public const int epProvider_WaterFromAgSurfaceMax = 104;
        public const int epWebPop_GrowthRateAdj_PCT = 105;

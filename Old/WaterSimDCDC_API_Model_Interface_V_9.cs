...
namespace WaterSimDCDC
{
    ...
    public class WaterSimU : IDisposable
    {
        ...
        /// </summary>
        const string FileBuild =  "03.15.14_22:01:00";
        //
             ...
             public WaterSimU(string Data, string Outputs, bool Write)
            {
                ...
                if (!Mycatch)
                {
                    //MessageBox.Show("Application Error: No connection to model dll");
                     throw new Interface_Exception(3);
                 }
               }
               // 
                      ~WaterSimU()
        ...
        /// 02.21.14 DAS
        /// </summary>
            //protected internal int[] get_EffluentWaterCreated  // 
            //{
            //    get
            //    {
            //        int num = cNumFortranProviders;

     ...
     //   const string FortranDLLFilename = "WaterSimDCDC_model_5.dll";
      //  const string FortranDLLFilename = "WaterSimDCDC_model.dll";
       // const string FortranDLLFilename = "WaterSimDCDC_model_6.dll";
        ...
        /// </summary>
        const string FileBuild =  "07.28.16_8:51:00";
        //
        ...
        /// </summary>
           ...
           [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            ...
            /// 08.10.16
            /// </summary>
            protected internal int get_NonPotableToTotalOutdoors
            {
                get
                {
                    int gvalue = 0;
                    return getNonPotableToTotal_(ref gvalue);
                }
            }
            [DllImport(@FortranDLLFilename, CallingConvention = CallingConvention.Cdecl)]
            protected static extern int getNonPotableToTotal_(ref int values);
            //
            /// <summary>

...
namespace WaterSimDCDC
{
    ...
    public class eModelParam
    {
        ...
        public const int epWebPop_GrowthRateAdj_PCT = 107;
        //
        ...
        //
        public const int epTotalReclaimedCreated_AF = 261;
        public const int epTWWTPCreated_AF = 262;
        ...
        public const int epMeadShortageSharing = 317;
        ...
        //-------------
        public const int FirstSensitivityAnalysesParameter = 1701;
         //-------------
        // DAS Added 06.15.14 and 06.16.14
            public const int epRunManyYears = 1701;
            public const int epNparameterValues = 1702;
            public const int epNparameters = 1703;
            // FOR Inputs
            public const int epSaltVerde_Trace = 1705;
            public const int epCO_Trace = 1706;
            // FOR outputs
            public const int epSaltOther_Storage = 1800;
            public const int epRoosevelt_Storage = 1801;
            public const int epVerde_Storage = 1802;

        /// <summary> The last user defined Parameter </summary>
        /// <remarks> Reserved Value</remarks>
        public const int LastSensitivityAnalyses = 1900;


        //=========================================
        /// <summary> The names  of the Parameters. </summary>

        internal static int[] ParmNameIndex = new int[165]
        {
            0 ,    //     		epColorado_River_Flow
            1 ,    //     		epPowell_Storage
            2 ,    //     		epMead_Storage
            3 ,    //     		epSaltVerde_River_Flow
            ...
            27 ,    //     		epGPCD_Used
            28 ,    //     		epPopulation_Used
            29 ,    //     		epSaltVerde_Spillage
            30 ,    //     		epSimulation_Start_Year
            31 ,    //     		epSimulation_End_Year
            ...
            105 ,    //     		epWebPop_GrowthRateAdj_PCT
            ...
            252 ,    //     		epWebUIeffluent
            253 ,    //     		epWebUIeffluent_Ag
            254 ,    //     		epWebUIeffluent_Env
            255 ,    //     		epWebUIAgriculture
            256 ,    //     		epWebUIPersonal
        ...
        internal static string[] ParmNames = new string[165]
        {
            ...
            "epWebUIeffluent",  //     					    = 252"
            "epWebUIeffluent_Ag",  //     					 = 253"
            "epWebUIeffluent_Env",  //     					 = 254"
            "epWebUIAgriculture",  //     					 = 255"
            "epWebUIPersonal",  //     					    = 256"
   ...
   public class providerArrayProperty : providerArrayPropertyBaseClass
   {
       ...
       //public override void setvalues(ProviderIntArray value, ref bool isError, ref string errMessage)
       //{
       //    if (Fset == null) {throw new WaterSim_Exception(WS_Strings.wsReadOnly); }
       //    if (!Fpm.CheckProviderValuesRange(Femp, value))
       //    {
       //        isError = true;
       //        string temp = "";
       //        foreach (int val in value.FValues)
       //        {
       //            temp += val.ToString() + ",";
       //            errMessage = "Invalid Value For Set Found, " + Fpm.Model_Parameter(Femp).Label + " Values:" + temp;
       //        }
       //    }
       //    Fset(value.Values);
       //}

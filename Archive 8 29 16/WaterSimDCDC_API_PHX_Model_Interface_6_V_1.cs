     ...
     //   const string FortranDLLFilename = "WaterSimDCDC_model_5.dll";
      //  const string FortranDLLFilename = "WaterSimDCDC_model.dll";
       // const string FortranDLLFilename = "WaterSimDCDC_model_6.dll";
        ...
        /// </summary>
        const string FileBuild =  "05.26.16_12:30:00";
        //
            ...
            // 
             ...
             public WaterSimU(string Data, string Outputs, bool Write)
             {
                  ...
                  try
                 {
                     ...
                     {
                         throw new Exception("FORTRAN MODEL did not successfully find the data files");
                     }

                 }
                 catch (IOException e)
                 {
                     throw new Exception("FORTRAN MODEL did not successfully find the data files" + e);
                 }
                 // Open the Log File and testing files
                 //OpenFiles_();
                 //// ------------------------------
                 //_dataDirectoryName = Data;
                 //_tempDirectoryName = Outputs;
          ...
          //
            ...
            /// NO LONGER ACCURATE - okay 06.17.16
            /// </summary>

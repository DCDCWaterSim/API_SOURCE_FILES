       ...
       // Values 0 to 200 reserved for Basic Model Inpus and Outputs
        ...
        partial void  initialize_WaterSim_6_ModelParameters()
        {
           ...
           // WaterSimManager WSim = (this as WaterSimManager);
            ...
            //
            this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epRainFallFactor, "Rainfall factor: ", "RAINFAC", rangeChecktype.rctCheckRange, 50, 150, geti_RainFallFactor, seti_RainFallFactor, RangeCheck.NoSpecialBase));
            ...
            //
             ...
             this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epProvider_ResIndoorGPCD_LD, "LD Indoor", "LRINGPCD", ResidentialLowDensityIndoorGPCD, 0, 200));
             ...
             this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epProvider_ResOutdoorGPCD_LD, "LD Outdoor", "LROUTGPCD", ResidentialLowDensityOutdoorGPCD, 0, 400));
             ...
             this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epProvider_ResIndoorGPCD_MD, "MD Indoor", "MRINGPCD", ResidentialMediumDensityIndoorGPCD, 0, 200));
             ...
             this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epProvider_ResOutdoorGPCD_MD, "MD Outdoor", "MROUTGPCD", ResidentialMediumDensityOutdoorGPCD, 0, 400));
            ...
            //
             ...
             this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epProvider_ResIndoorGPCD_HD, "HD Indoor", "HRINGPCD", ResidentialHighDensityIndoorGPCD, 0, 200));
             ...
             this.ParamManager.AddParameter(new ModelParameterClass(eModelParam.epProvider_ResOutdoorGPCD_HD, "HD Outdoor", "HROUTGPCD", ResidentialHighDensityOutdoorGPCD, 0, 400));
...
//        internal int[] geti_demand_Agriculture() { return _ws.get_WaterDemand_Agriculture; }
        ...
        //
         ...
         //
         //private int get_ComTotalWaterUse() { return ComWaterUse; }
         //public int ComWaterUse
         //{ get { return _ws.get_ComWaterUsed; } }
         //
        ...
        //
         void Initial(int Scenario, WaterSimU WSU)
         {
             ...
             {  
                 case 7:
                    // string path = @"BAU\";
                     WSU.set_parmCalculateRainWaterHarvesting = true;
                     WSU.set_parmCalculateRainWaterResidentialOnly = false;
                     WSU.set_parmCalculateRainWaterCommercialOnly = false;
                     for (int i = 0; i < ProviderClass.NumberOfProviders; i++) { OneHundred[i] = 100; }
                     Out.Values = OneHundred;
                     this.StormWaterStructural_Capacity.setvalues(Out);

                     WSU.set_parmCalculateStormWaterHarvesting = true;
                     WSU.set_parmCalculateGrayWater = true;                     
                     WSU.set_parmGrayWaterCompliancePCT = 30;
                     WSU.set_parmYearsToAdopt = 15;
         ...
         void Init(int Scenario, WaterSimU WSU)
         {
             ...
             switch (Scenario)
             {
                 ...
                 case 1:
                     ...
                     WSU.set_parmCalculateStormWaterHarvesting = true;
                     // NOTE: Using a value > 0 for the Structural Capacity overrides 
                     ...
                     WSU.set_parmGrayWaterCompliancePCT = 90;
                     //
                     // Bank excess CAP surface Water
                     for (int i = 0; i < ProviderClass.NumberOfProviders; i++) { OneHundred[i] = 100; }
                     Out.Values = OneHundred;
                     this.PCT_SurfaceWater_to_WaterBank.setvalues(Out);
                     // If yearsToAdopt == 1, then the response equals 1.0 (no delay in the policy)
                     // For Logistic, years are years to the inflection point
                     //set_parmYearsToAdopt = 15;
                     //
                     WSU.set_parmIwaniecNoLeaks = true;
                     // Linearly reduce effluent goint to Paleo Verde over time.
                     WSU.set_parmIwaniecPPtoAgEffluent = true;
                 ...
                 case 2:
                     ...
                     this.StormWaterStructural_Capacity.setvalues(Out);
                     WSU.set_parmCalculateGrayWater = true;
                     WSU.set_parmGrayWaterCompliancePCT = 77;
                     WSU.set_parmYearsToAdopt = 15;
                     WSU.set_parmIwaniecNoLeaks = false;
                     WSU.set_parmIwaniecPPtoAgEffluent = false;
                     WAugParm.Value = 0;
                 ...
                 case 3:
                     ...
                     WSU.set_parmCalculateStormWaterHarvesting = false;
                     WSU.set_parmCalculateGrayWater = true;
                     WSU.set_parmGrayWaterCompliancePCT = 95;
                     WSU.set_parmYearsToAdopt = 15;
                     WSU.set_parmIwaniecNoLeaks = false;
                     WSU.set_parmIwaniecPPtoAgEffluent = false;
                     WAugParm.Value = 0;
                 ...
                 case 4:
                     ...
                     WSU.set_parmCalculateRainWaterHarvesting = false;
                     WSU.set_parmCalculateRainWaterResidentialOnly = true;
                     WSU.set_parmCalculateStormWaterHarvesting = true;
                      for (int i = 0; i < ProviderClass.NumberOfProviders; i++) { zero[i] = 0; }
                     Out.Values = zero;
                     this.StormWaterStructural_Capacity.setvalues(Out);
                     ...
                     WSU.set_parmCalculateGrayWater = true;
                     WSU.set_parmGrayWaterCompliancePCT = 100;
                     WSU.set_parmYearsToAdopt = 15;
                     WSU.set_parmIwaniecNoLeaks = false;
                     WSU.set_parmIwaniecPPtoAgEffluent = true;
                     WAugParm.Value = 0;
                 ...
                 case 5:
                     ...
                     WSU.set_parmCalculateRainWaterResidentialOnly = false;
                     WSU.set_parmCalculateStormWaterHarvesting = true;
                     // Using the Structural Capacity overrides banking
                     for (int i = 0; i < ProviderClass.NumberOfProviders; i++) { OneHundred[i] = 1000; }
                     Out.Values = OneHundred;
                     this.StormWaterStructural_Capacity.setvalues(Out);
                     ...
                     for (int i = 0; i < ProviderClass.NumberOfProviders; i++) { Zero[i] = 0; }
                     Out.Values = Zero;
                     this.PCT_Effluent_to_Vadose.setvalues(Out);
                     //
                     for (int i = 0; i < ProviderClass.NumberOfProviders; i++) { Ninty[i] = 80; }
                     Out.Values = Ninty;
                     this.PCT_Wastewater_to_Effluent.setvalues(Out);
                     //
                     WSU.set_parmIwaniecPPtoAgEffluent = true;
                     WAugParm.Value = 0;
                 ...
                 case 6:
                     ...
                     WSU.set_parmCalculateRainWaterResidentialOnly = false;
                     WSU.set_parmCalculateStormWaterHarvesting = true;
                     // Using the Structural Capacity override of zero
                      for (int i = 0; i < ProviderClass.NumberOfProviders; i++) { zero[i] = 0; }
                     Out.Values = zero;
                     this.StormWaterStructural_Capacity.setvalues(Out);

                     WSU.set_parmCalculateGrayWater = true; // change from initial
                     WSU.set_parmGrayWaterCompliancePCT = 100;
                     WSU.set_parmYearsToAdopt = 15;
                     WSU.set_parmIwaniecNoLeaks = true;
                     for (int i = 0; i < ProviderClass.NumberOfProviders; i++) { Zero[i] = 0; }
                 ...
                 default:
                     ...
                     WSU.set_parmIncludeMeteorology = true;
                     WSU.set_parmCalculateRainWaterHarvesting = false;
                     WSU.set_parmCalculateRainWaterCommercialOnly = true;
                     WSU.set_parmCalculateStormWaterHarvesting = false;
                    ...
                    WSU.set_parmCalculateGrayWater = false;
                    WSU.set_parmYearsToAdopt = 15;
                    WSU.set_parmIwaniecNoLeaks = false;
                            // WWtoReclaimed.Value = 0;
                            // WWtoEff.Value = 100;

...
namespace WaterSimDCDC
{
    ...
    public class eModelParam
    {
        ...
        // 08.04.14 das
        public const int epCAP_DemandNotMet_Priority4 = 113;
        public const int epCAP_DemandNotMet_Priority5 = 114;
        ...
        public const int epWebReclaimedWater = 125;
       ...
       // 02.17.15
        ...
        public const int epWebUIPersonal = 606;

        // adjusts all providers water bank pct based on single value from Web UI
        public const int epWebWaterBankPCT = 607;
